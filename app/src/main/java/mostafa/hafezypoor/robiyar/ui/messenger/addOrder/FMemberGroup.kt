...
class FMemberGroup(val iEvent: IEvent) : Fragment(R.layout.fmember_group){
    ...
    private lateinit var groupID : TextInputEditText
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        groupID = view.findViewById<TextInputEditText>(R.id.groupID)
        ...
        btnAddOrder.setOnClickListener {
            if (groupID.text.toString().isEmpty()){
                ...
                viewModel.addMemberShipGroup(token,groupID.text.toString().trim(),countOrder.text.toString().trim())
                viewLifecycleOwner.lifecycleScope.launch {
